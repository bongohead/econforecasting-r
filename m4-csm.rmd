...
M3_PATH = 'D:/Onedrive/__Projects/econforecasting/model-outputs/[2021-08-21] m3.rds'
...
## Get coefficients of identity equations
```{r}
local({
	...
	coefMatsIdentity = list(
        gdp =
    		tibble(gdp = 1, pce = -1 * ss$pce/ss$gdp, pdi = -1 * ss$pdi/ss$gdp, im = ss$im/ss$gdp, ex = -1 * ss$ex/ss$gdp, govt = -1 * ss$govt/ss$gdp),
        pce =
        	tibble(pce = 1, pceg = -1 * ss$pceg/ss$pce, pces = -1 * ss$pces/ss$pce),
        pceg = 
        	tibble()
        govt =
        	tibble(govt = 1, govtf = -1 * ss$govtf/ss$govt, govts = -1 * ss$govts/ss$govt)
        )
...
local({
    ...
    eqnsList =
        list(
        	pceg = 'pceg = constant + pid + lma2.pceg + lma2.ue',
        	pces = 'pces = constant + pid + lma2.pces + lma2.ue',
            pdin = 'pdin = constant + ue + lma2.pdin',
            pdir = 'pdir = constant + ue + hpi + lma2.pdir',
            im = 'im = constant + ue + lma2.im',
            ex = 'ex = constant + ue + lma2.ex',
            pdi = 'pdi = constant + pdin + pdir',
            govtf = 'govtf = constant + govt + lma2.govtf + lma2.ue',
            govts = 'govts = constant + govt + lma2.govts + lma2.ue',
            houst = 'houst = constant + hpi + lma2.houst + lma2.ue + mort30y',
            hsold = 'hsold = constant + hpi + lma2.hsold + lma2.ue + mort30y',
            vix = 'vix = constant + vix.l1 + spy + spy.l1',
            moo = 'moo = constant + moo.l1 + spy + gdp',
            metals = 'metals = constant + metals.l1 + spy + gdp'
        	)
