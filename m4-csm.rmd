...
M3_PATH = 'D:/Onedrive/__Projects/econforecasting/model-outputs/[2021-08-16] m3.rds'
...
## Replace with Quarterly Nowcasts
```{r}
local({
...
local({
    ...
    eqnsList =
        list(
        	pceg = 'pceg = constant + pid + _lma2.pceg + _lma2.ue',
        	pces = 'pces = constant + pid + _lma2.pces + _lma2.ue',
            ...
            govtf = 'govtf = constant + govt + _lma2.govtf + _lma2.ue',
            govts = 'govts = constant + govt + _lma2.govts + _lma2.ue',
            houst = 'houst = constant + hpi + _lma2.houst + _lma2.ue + mort30y',
            hsold = 'hsold = constant + hpi + _lma2.hsold + _lma2.ue + mort30y',
