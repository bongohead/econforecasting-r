...
local({
    ...
    eqnsList = list(
    	'pcegdmotor = constant + wma2.pid + ma2.ue + lma2.pcegdmotor + oil',
    	'pcegdfurnish = constant + wma2.pid + ma2.ue + lma2.pcegdfurnish',
    	'pcegdrec = constant + wma2.pid + ma2.ue + lma2.pcegdrec',
    	'pcegdother = constant + wma2.pid + ma2.ue + lma2.pcegdother',
    	'pcegnfood = constant + wma2.pid + ma2.ue + lma2.pcegnfood',
    	'pcegnclothing = constant + wma2.pid + ma2.ue + lma2.pcegnclothing',
    	'pcegngas = constant + wma2.pid + ma2.ue + lma2.pcegngas',
    	'pcegnother = constant + wma2.pid + ma2.ue + lma2.pcegnother',
    	'pceshousing = constant + wma2.pid + ma2.ue + lma2.pceshousing',
    	'pceshealth = constant + wma2.pid + ma2.ue + lma2.pceshealth',
    	'pcestransport = constant + wma2.pid + ma2.ue + lma2.pcestransport',
    	'pcesrec = constant + wma2.pid + ma2.ue + lma2.pcesrec',
    	'pcesfood = constant + wma2.pid + ma2.ue + lma2.pcesfood',
    	'pcesfinal = constant + wma2.pid + ma2.ue + lma2.pcesfinal',
    	'pcesother = constant + wma2.pid + ma2.ue + lma2.pcesother',
    	'pcesnonprofit = constant + wma2.pid + ma2.ue + lma2.pcesnonprofit',
