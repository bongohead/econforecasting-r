		...
		purrr::map_dfr(., function(var) {
			...
			httr::GET(
				...
				add_headers(c(
					...
					'Cookie'='ak_bmsc=7F4B0C1D5A31ACB51F193F8861397A7917DA5DAD647500000DAAAD600E3CB24D~plFJ4Tbept5nXUkwa+6RIih783P/+iXHDdnDNbFqJ4idRAbPKtcBJUiD526B10azgLWCwEg+2oGA2c8dUkNNPBQL5eFgss7PISIKvTy/zTslJ8TuPcXfJ7P9w5nbXA5+SN2XRX0DQBISuPhJQreV/bBXY9Zkjj06RD9NhSB0cZZ+JwNi547S+8INij+v8nFUM20ldLZ4s9Ei6XD/cMQw/u9EXyBUYTkqhras9nmMZUVZQ=',
					'DNT' = '1',
