...
\begin{align*}
\underbrace{\begin{bmatrix}
\vv{f^1}_{2} & \vv{f^2}_{2} & \dots & \vv{f^R}_{2}\\
\vv{f^1}_{3} & \vv{f^2}_{3} & \dots & \vv{f^R}_{3}\\
\vdots & \vdots & \vdots & \vdots \\
\vv{f^1}_{T} & \vv{f^2}_{T} & \dots & \vv{f^R}_{T}
\end{bmatrix}}_{\Gamma}
=
\underbrace{\begin{bmatrix}
1 & \vv{f^1}_{1} & \vv{f^2}_{1} & \dots & \vv{f^R}_{1}\\
1 & \vv{f^1}_{2} & \vv{f^2}_{2} & \dots & \vv{f^R}_{2}\\
\vdots & \vdots & \vdots & \vdots & \vdots \\
1 & \vv{f^1}_{T-1} & \vv{f^2}_{T-1} & \dots & \vv{f^R}_{T-1}
\end{bmatrix}}_{\Psi}
\underbrace{\begin{bmatrix}
C'\\
B'
...
\begin{equation}
\underbrace{\begin{bmatrix}
\vv{x^1}_{2} & \vv{x^2}_{2} & \dots & \vv{x^N}_{2}\\
\vv{x^1}_{3} & \vv{x^2}_{3} & \dots & \vv{x^N}_{3}\\
\vdots & \vdots & \vdots & \vdots \\
\vv{x^1}_{T} & \vv{x^2}_{T} & \dots & \vv{x^N}_{T}\\
\end{bmatrix}}_{\Phi}
=
\underbrace{\begin{bmatrix}
1 & \vv{f^1}_{2} & \vv{f^2}_{2} & \dots & \vv{f^R}_{2}\\
1 & \vv{f^1}_{3} & \vv{f^2}_{3} & \dots & \vv{f^R}_{3}\\
\vdots & \vdots & \vdots & \vdots & \vdots \\
1 & \vv{f^1}_{T} & \vv{f^2}_{T} & \dots & \vv{f^R}_{T}\\
\end{bmatrix}}_{\Omega}
\begin{bmatrix}
D'\\
A'
...
=
\begin{bmatrix}
	\text{$\vv{x^1}_{t}$ if available, otherwise 0}\\
	\text{$\vv{x^2}_{t}$ if available, otherwise 0}\\
	\vdots \\
	\text{$\vv{x^N}_{t}$ if available, otherwise 0}\\
