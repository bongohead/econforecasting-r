...
# EF_PY=$([ "$HOSTNAME" = "econforecasting.com" ] && echo "/home/charles/.pyenv/versions/3.8.7/bin/python3.8" || echo "C:/Users/Charles/AppData/Local/r-reticulate/r-reticulate/pyenv/pyenv-win/versions/3.8.7/python.exe")
