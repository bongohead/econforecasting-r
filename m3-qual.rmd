...
M2_PATH = 'D:/Onedrive/__Projects/econforecasting/model-outputs/[2021-08-16] m2.rds'
			...
			plots =
				...
				lapply(., function(y) {
					...
					dplyr::bind_rows(histDf, forecastDf) %>%
						...
						scale_color_manual(
							values = c('Historical' = 'black', 'Forecast' = 'Red')
						) +
						scale_linetype_manual(
							values = c('Historical' = 'solid', 'Forecast' = 'solid')
						) +
						labs(
