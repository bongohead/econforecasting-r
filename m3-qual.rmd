...
M2_PATH = 'D:/Onedrive/__Projects/econforecasting/model-outputs/[2021-07-30] m2.rds'
...
local({
    ...
    baseline$mort15yt10yspread =
    	...
    	dplyr::mutate(., value = undiff(value, 1, tail(p$variables$mort15yt10yspread$h$d1$m, 1)$value))
    ...
    baseline$mort30yt30yspread =
    	...
    	dplyr::mutate(., value = undiff(value, 1, tail(p$variables$mort30yt30yspread$h$d1$m, 1)$value))  
