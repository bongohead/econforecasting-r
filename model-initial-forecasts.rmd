...
Calculated TDNS2: -1 * (t10y - t3m)
Calculated TDNS3: .3 * (2*t02y - t03m - t10y)
Keep these treasury yield forecasts as the external forecasts ->
note that later these will be "regenerated" in the baseline calculation, may be off a bit due to calculation from TDNS, compare to og
```{r}
local({
    ...
    ef$e$forecasts$dns <<- dplyr::bind_rows(df, df1)
})
```
