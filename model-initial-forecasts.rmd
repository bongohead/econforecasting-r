...
## Create Initial - Baseline Forecasts
```{r}
local({

    initial = list()
    
    initial$ffr = ef$e$forecasts$cme %>% dplyr::filter(., varname == 'ffr')
    initial$sofr = ef$e$forecasts$cme %>% dplyr::filter(., varname == 'sofr')
    
    initial$inf = ef$e$forecasts$
    

})
```

## Initial - Other Scenario Forecasts
```{r}
local({
