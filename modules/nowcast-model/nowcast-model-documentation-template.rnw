...
\usepackage{fancyhdr}
\usepackage{appendix}
\graphicspath{{\Sexpr{file.path(EF_DIR, 'modules', 'nowcast-model', 'documentation-images')}}}
...
<<echo=F,results='hide',message=F, warning=F>>=
  ...
  knitr::opts_chunk$set(
    echo = F, results = 'asis',
    root.dir = file.path(EF_DIR, 'modules', 'nowcast-model'),
    fig.path = file.path(EF_DIR, 'logs', 'latex-figures'),
    cache.path = file.path(EF_DIR, 'logs', 'latex-cache'),
