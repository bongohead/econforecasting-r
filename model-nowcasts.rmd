...
RESET_ALL = FALSE
VINTAGE_DATE = Sys.Date() #as.Date('2021-05-21')#Sys.Date() # Date to pull data "as-of", for general use set this as Sys.Date(); otherwise set as an older date for backtesting
```
