...
\vskip\baselineskip
\noindent
\textsf{Model Run Date: April 17, 2021}\\
...
The model is run every weekday; this documentation will use actual data and estimates from the most recent model run (2021-04-17) to illustrate the procedure. The final nowcasted output is located in the results section.
...
Consumption: Goods: Durable: Motor Vehicles \& Parts & 0.10 & 0.09 & 0.04 \\ 
  ...
  Gross Private Domestic Investment: Change in Private Inventories & 122.49 & 200.21 & 184.20 \\ 
...
Variable & 2021Q1 & 2021Q2 & 2021Q3 \\ 
  \hline
\hspace{0mm} \textbf{GDP} & 8.98 & 10.10 & 4.84 \\ 
  \hspace{0mm} \textbf{Consumption} & 9.67 & 4.91 & 3.23 \\ 
  ...
  \hspace{8mm}  Services & -1.58 & -1.21 & 0.36 \\ 
  ...
  \hspace{0mm} \textbf{Gross Private Domestic Investment} & 20.85 & 33.54 & 11.32 \\ 
  ...
  \hspace{8mm}  Change in Private Inventories & 122.49 & 200.21 & 184.20 \\ 
  \hspace{0mm} \textbf{Net Exports} & -1125.87 & -1095.97 & -1079.05 \\ 
  \hspace{0mm} \textbf{Exports} & 12.11 & 10.85 & 8.31 \\ 
  \hspace{8mm}  Exported Goods & 2.75 & 2.75 & 2.75 \\ 
  \hspace{8mm}  Exported Services & 14.94 & 36.56 & 24.16 \\ 
  ...
  \hspace{0mm} \textbf{Government Spending} & -0.66 & -0.14 & 0.16 \\ 
  \hspace{8mm}  Federal & -1.23 & -0.19 & -0.28 \\ 
  \hspace{8mm}  State \& Local & -0.47 & -0.11 & 0.46 \\ 
   \hline 
...
Delinquency Rate on Residential Mortgages & 2.90 & 2.90 & 3.16 \\ 
  ...
  Delinquency Rate on Commercial $\backslash$\& Industrial Loans & 1.29 & 1.27 & 1.22 \\ 
   \hline
\end{tabular}
\endgroup
