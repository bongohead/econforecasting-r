...
\vskip\baselineskip
\noindent
\textsf{Model Run Date: June 29, 2021}\\
...
The model is run every weekday; this documentation will use actual data and estimates from the most recent model run (2021-06-29) to illustrate the procedure. The final nowcasted output is located in the results section.
...
Consumption: Goods: Durable: Motor Vehicles \& Parts & 0.01 & 0.04 \\ 
  ...
  Consumption: Goods: Durable: Other Durable Goods & 0.03 & 0.07 \\ 
  ...
  Gross Private Domestic Investment: Nonresidential Investment: Equipment & 0.03 & 0.04 \\ 
  ...
  Gross Private Domestic Investment: Change in Private Inventories & 33.08 & 89.98 \\ 
  Exports: Exported Goods & 0.01 & 0.01 \\ 
  Exports: Exported Services & 0.02 & 0.04 \\ 
  Imports: Imported Goods & 0.02 & 0.02 \\ 
  Imports: Imported Services & 0.01 & 0.01 \\ 
...
Variable & 2021Q2 & 2021Q3 \\ 
  \hline
\hspace{0mm} \textbf{GDP} & 8.14 & 7.61 \\ 
  \hspace{0mm} \textbf{Consumption} & 9.65 & 7.16 \\ 
  \hspace{8mm}  Goods & 6.33 & 11.38 \\ 
  \hspace{16mm}  Durable & 12.84 & 17.76 \\ 
  \hspace{24mm}  Motor Vehicles \& Parts & 3.81 & 16.62 \\ 
  \hspace{24mm}  Furnishings \& Durable Household Equipment & -3.43 & 22.35 \\ 
  \hspace{24mm}  Recreational Goods \& Services & 10.94 & 10.94 \\ 
  \hspace{24mm}  Other Durable Goods & 13.58 & 30.98 \\ 
  \hspace{16mm}  Nondurable Goods & -3.44 & 6.99 \\ 
  \hspace{24mm}  Food \& Beverages for Off-Premises Use & -5.50 & 5.20 \\ 
  \hspace{24mm}  Clothing & 13.81 & 24.62 \\ 
  \hspace{24mm}  Gasoline \& Energy Goods & 1.65 & 2.96 \\ 
  \hspace{24mm}  Other Nondurable Goods & 3.85 & 3.85 \\ 
  \hspace{8mm}  Services & 2.41 & 4.36 \\ 
  \hspace{16mm}  Housing \& Utilities & 1.25 & 1.25 \\ 
  \hspace{16mm}  Health Care & 5.21 & 6.89 \\ 
  \hspace{16mm}  Transportation & 7.97 & 11.74 \\ 
  \hspace{16mm}  Recreation & 6.37 & 10.39 \\ 
  \hspace{16mm}  Food Services \& Accomodations & 5.97 & 8.79 \\ 
  \hspace{16mm}  Financial Services & 3.15 & 2.64 \\ 
  \hspace{16mm}  Other Services & 4.88 & 6.91 \\ 
  \hspace{16mm}  Nonprofit Services & -12.37 & -14.33 \\ 
  \hspace{0mm} \textbf{Gross Private Domestic Investment} & 18.93 & 15.59 \\ 
  \hspace{8mm}  Nonresidential Investment & 12.39 & 9.77 \\ 
  \hspace{16mm}  Structures & 0.82 & 0.82 \\ 
  \hspace{16mm}  Equipment & 12.50 & 15.43 \\ 
  \hspace{16mm}  Intellectual Property & 6.21 & 6.51 \\ 
  \hspace{8mm}  Residential Investment & 5.51 & 5.51 \\ 
  \hspace{8mm}  Change in Private Inventories & 33.08 & 89.98 \\ 
  \hspace{0mm} \textbf{Net Exports} & -1241.22 & -1261.30 \\ 
  \hspace{0mm} \textbf{Exports} & 11.49 & 7.28 \\ 
  \hspace{8mm}  Exported Goods & 3.46 & 4.08 \\ 
  \hspace{8mm}  Exported Services & 10.02 & 16.95 \\ 
  \hspace{0mm} \textbf{Imports} & 10.93 & 7.05 \\ 
  \hspace{8mm}  Imported Goods & 6.23 & 7.50 \\ 
  \hspace{8mm}  Imported Services & 2.43 & 3.73 \\ 
  \hspace{0mm} \textbf{Government Spending} & 1.00 & 0.79 \\ 
  \hspace{8mm}  Federal & 0.42 & 0.29 \\ 
  \hspace{8mm}  State \& Local & 0.94 & 1.14 \\ 
   \hline 
...
Variable & 2021Q2 & 2021Q3 \\ 
  \hline
Delinquency Rate on Residential Mortgages & 3.02 & 3.30 \\ 
  Delinquency Rate on Credit Cards & 1.95 & 2.02 \\ 
  Delinquency Rate on Commercial $\backslash$\& Industrial Loans & 1.14 & 1.11 \\ 
   \hline
\end{tabular}
\endgroup
...
Variable & 2021M5 & 2021M6 & 2021M7 & 2021M8 & 2021M9 \\ 
  \hline
PCE \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 40.42 & 9.56 & 1.58 & -0.40 \\ 
  PCE: Goods \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 44.34 & 9.67 & 1.21 & -0.58 \\ 
  PCE: Goods: Durable Goods \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 66.83 & 11.92 & -0.03 & -2.15 \\ 
  PCE: Goods: Nondurable Goods \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 34.03 & 8.55 & 1.86 & 0.25 \\ 
  PCE: Services \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 38.37 & 9.50 & 1.79 & -0.26 \\ 
  Personal Income \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & -9.50 & -1.74 & 1.07 & 2.10 \\ 
  Disposable Personal Income \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & -12.50 & -2.91 & 0.58 & 1.85 \\ 
  Personal Outlays \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 43.92 & 11.83 & 3.50 & 1.40 \\ 
  Personal Savings \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & -83.27 & -36.48 & -2.29 & 11.66 \\ 
  Personal Savings Rate &  & 0.12 & 0.12 & 0.12 & 0.12 \\ 
  Case-Shiller Housing Price Index & 250.12 & 251.28 & 252.14 & 252.95 & 253.78 \\ 
  Housing Starts &  & 1705.25 & 1740.67 & 1744.80 & 1741.21 \\ 
  Houses Sold &  & 802.70 & 807.78 & 804.83 & 800.67 \\ 
  New Private Housing Permits &  & 1772.59 & 1796.03 & 1799.39 & 1798.33 \\ 
  Manufacturers New Orders: Durable Goods &  & 264303.81 & 266601.66 & 266248.66 & 265280.96 \\ 
  Capacity Utilization: Total Index &  & 77.28 & 77.85 & 77.93 & 77.88 \\ 
  Total Construction Spending & 1532804.58 & 1548758.69 & 1557666.79 & 1564463.31 & 1570764.89 \\ 
  ...
  Vehicle Sales &  & 17.39 & 16.93 & 16.73 & 16.63 \\ 
  Unemployment Rate &  & 4.81 & 4.53 & 4.45 & 4.43 \\ 
  All Employees (Nonfarm) &  & 148224.73 & 149302.81 & 149640.68 & 149749.37 \\ 
  Job Openings: Total Nonfarm & 9454.69 & 10034.68 & 10228.83 & 10299.57 & 10338.10 \\ 
  S\&P 500 \textit{\footnotesize\textcolor{gray}{(pchg)}} &  &  & 1.09 & 0.76 & 0.70 \\ 
  VIX &  &  & 14.24 & 14.91 & 15.44 \\ 
  Crude Oil Price (West Texas Intermediate) &  & 73.46 & 73.18 & 72.23 & 71.18 \\ 
  Outstanding Real Estate Loans \textit{\footnotesize\textcolor{gray}{(apchg)}} &  &  & 2.07 & 2.29 & 2.36 \\ 
  Outstanding Credit Card Balances \textit{\footnotesize\textcolor{gray}{(apchg)}} &  &  & 18.34 & 16.66 & 14.91 \\ 
  Housing Prices: New Listed Prices \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 17.99 & 12.69 & 11.24 & 10.97 \\ 
  St. Louis Fed Financial Stress Index &  &  & -0.56 & -0.46 & -0.41 \\ 
  U.S. Dollar Index &  & 104.11 & 104.03 & 104.24 & 104.52 \\ 
  Average Weeks Unemployed &  & 30.69 & 30.00 & 29.63 & 29.38 \\ 
  Retail \& Food Sales \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 57.03 & 9.97 & -0.93 & -3.22 \\ 
  KC Fed Labor Market Index &  & -0.04 & -0.02 & -0.04 & -0.08 \\ 
  Consumer Confidence (OECD) &  & 100.03 & 100.37 & 100.42 & 100.38 \\ 
  PCE Price Index \textit{\footnotesize\textcolor{gray}{(apchg)}} &  & 3.46 & 2.16 & 1.75 & 1.62 \\ 
  New York Fed: Business Conditions Manufacturing Survey &  &  & 15.57 & 13.30 & 11.87 \\ 
  Dallas Fed: Current General Business Activity &  &  & 14.37 & 11.55 & 9.85 \\ 
  Philadelphia Fed: Future Capital Expenditures Survey &  &  & 25.62 & 24.92 & 24.46 \\ 
  Baa Corporate Bond Yield &  &  & 4.92 & 4.97 & 4.95 \\ 
  Labor Force Participation Rate &  & 63.17 & 63.33 & 63.33 & 63.29 \\ 
   \hline 
 \textit{apchg} = annualized \% change 
\end{tabular}
\endgroup
