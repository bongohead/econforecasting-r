...
RESET_ALL = FALSE
VINTAGE_DATE = as.Date('2021-07-23') #Sys.Date() # Date to pull data "as-of", for general use set this as Sys.Date(); otherwise set as an older date for backtesting
	...
	df =
		...
		lapply(., function(x) {
			...
			df0 =
				...
				dplyr::filter(., value = as.numeric(value)) %>%
